...
let data = [[1, 1, 1], [1, 2, 1], [-1, -1, -1], [-1, -1, -1.5], [-1, -1, -1.5]];


function generateData() {
    for (let i = 0; i < DATA_SIZE; i++){
        for (let j = 0;j<3;j++){
            var a = randomBetween(-100,100);
            var b = randomBetween(-100,100);
            var c = randomBetween(-100,100);
            data.push(a);data.push(b);data.push(c)
        }
    }
...
console.log("kmeans done; results size = ", result.length)
printResults(result)
